...
// File: PresentationLayer/Views/SachGiaoKhoa.cs
namespace PresentationLayer.Views
{
    public partial class SachGiaoKhoa : SachView
    {
        public SachGiaoKhoa() : base(new SachGiaoKhoa(), new SachGiaoKhoaController())
        {
            InitializeComponent();
        }
        ...
        private void SachGiaoKhoa_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            controller.UpdateSach(new SachGiaoKhoa { MaSach = maSach, NgayNhap = ngayNhap, NhaXuatBan = nhaXuatBan, SoLuong = soLuong, DonGia = donGia, TinhTrang = tinhTrang });
            LoadData();
            ClearAll();
        }
        ...
        {
            DateTime ngayNhap = dateNgayNhap.Value;
            string query = "SELECT * from SachGiaoKhoa WHERE 1=1";
            if (txtMaSach.Text != "")
        ...
        private void btnBaoGia_Click(object sender, EventArgs e)
        {
            ...
            {
                tongTien = soLuong * donGia * 50 / 100;
            }

            txtBaoGia.Text = tongTien.ToString() + " VND";
        }
        private void SachGiaoKhoa_Leave(object sender, EventArgs e)
        {
            ClearAll();
        }
    }
